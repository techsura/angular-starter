...
const EXAMPLE_DATA: EventsListItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
...
export class EventsListDataSource extends DataSource<EventsListItem> {
  data: EventsListItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: EventsListItem[]): EventsListItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: EventsListItem[]): EventsListItem[] {
